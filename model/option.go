...
func InitOptionMap() {
	...
	common.OptionMap["AffiliateCommissionPercent"] = strconv.FormatFloat(common.AffiliateCommissionPercent, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AffiliateCommissionPercent":
		common.AffiliateCommissionPercent, _ = strconv.ParseFloat(value, 64)
