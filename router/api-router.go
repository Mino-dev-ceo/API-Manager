...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/verification", middleware.EmailVerificationRateLimit(), middleware.AuthRateLimit(), middleware.TurnstileCheck(), controller.SendEmailVerification)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/image-history", controller.GetUserImageHistory)
				selfRoute.GET("/image-content", controller.GetUserImageContent)
				selfRoute.POST("/images/generations/async", controller.CreateUserImageGenerationTask)
				selfRoute.POST("/images/edits/async", controller.CreateUserImageEditTask)
				selfRoute.GET("/images/tasks/:task_id", controller.GetImageTask)
				selfRoute.GET("/video-history", controller.GetUserVideoHistory)
				selfRoute.POST("/videos/generations/async", controller.CreateUserVideoGenerationTask)
				selfRoute.GET("/videos/tasks/:task_id", controller.GetUserVideoTask)
